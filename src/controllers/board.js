...
export default class BoardController {
  ...
  render() {
    ...
    const isAllTasksInArchived = tasks.every((task) => task.isArchive);
  ...
  _renderTasks(tasks) {
    ...
    const newTask = renderTasks(taskListElement, tasks, this._onDataChange, this._onViewChange);
  ...
  _onLoadMoreButtonClick() {
    ...
    const sortedTasks = getSortedTasks(tasks, this._sortComponent.getSortedType(), prevTasksCount, this._showingTasksCount);
    this._renderTasks(sortedTasks);
